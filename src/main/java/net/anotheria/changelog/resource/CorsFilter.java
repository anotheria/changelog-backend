...
import net.anotheria.changelog.common.config.ApplicationConfig;
...
public class CorsFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        accessControlAllowHeaders = "origin, content-type, content-disposition, accept, authorization";
        accessControlAllowHeaders = String.join(", ", accessControlAllowHeaders, /*Constants.AUTH_TOKEN, Constants.LANGUAGE_HEADER,*/ "token");
